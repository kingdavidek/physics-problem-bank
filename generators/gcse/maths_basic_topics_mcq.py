...
_FDP_MCQ_BANK = [
    {"q": "0.25 as a percentage is:",
     ...
     "hint": "<strong>Key idea:</strong> multiply the decimal by 100 to convert to %. 0.25 × 100 = 25%."},
    {"q": "50% as a decimal is:",
     "opts": ["A  0.05", "B  0.5", "C  5", "D  50"],
     "ans": "B", "marks": 1, "difficulty": "foundational",
     "sol": "50÷100=<strong>0.5</strong>. Answer: B",
     "hint": "<strong>Key idea:</strong> divide by 100 (or move the decimal point two places left). 50 ÷ 100 = 0.5."},
    {"q": "1/4 as a decimal is:",
     "opts": ["A  0.4", "B  0.25", "C  0.14", "D  4"],
     "ans": "B", "marks": 1, "difficulty": "foundational",
     "sol": "1÷4=<strong>0.25</strong>. Answer: B",
     "hint": "<strong>Key idea:</strong> divide the numerator by the denominator. 1 ÷ 4 = 0.25."},
    {"q": "0.75 as a fraction in simplest form is:",
     "opts": ["A  75/100", "B  3/4", "C  7/5", "D  3/5"],
     "ans": "B", "marks": 1, "difficulty": "foundational",
     "sol": "<strong>3/4</strong>. Answer: B",
     "hint": "<strong>Key idea:</strong> 0.75 = 75/100, then simplify by dividing top and bottom by 25 → 3/4."},
    {"q": "20% as a fraction in simplest form is:",
     ...
     "hint": "<strong>Key idea:</strong> write over 100 first: 20% = 20/100, then simplify → 1/5."},
    {"q": "3/5 as a percentage is:",
     "opts": ["A  35%", "B  60%", "C  53%", "D  0.6%"],
     "ans": "B", "marks": 1, "difficulty": "foundational",
     "sol": "3/5=0.6=<strong>60%</strong>. Answer: B",
     "hint": "<strong>Key idea:</strong> fraction → decimal (3 ÷ 5 = 0.6), then × 100 → 60%."},
    {"q": "0.125 as a fraction is:",
     ...
     "hint": "<strong>Key idea:</strong> 0.125 is 125 thousandths = 125/1000, simplify → 1/8."},
    {"q": "37.5% as a fraction is:",
     "opts": ["A  3/8", "B  3/4", "C  37/5", "D  3/10"],
     "ans": "A", "marks": 2, "difficulty": "intermediate",
     "sol": "37.5%=0.375=<strong>3/8</strong>. Answer: A",
     "hint": "<strong>Key idea:</strong> 37.5% = 37.5/100 = 375/1000 = 3/8 in simplest form."},
    {"q": "Which is the largest?",
     ...
     "hint": "<strong>Key idea:</strong> convert all to decimals: 0.4, 3/8=0.375, 38%=0.38, 2/5=0.4 — then compare."},
    {"q": "1/3 as a decimal (to 2 d.p.) is about:",
     "opts": ["A  0.33", "B  0.3 exactly", "C  3.0", "D  0.13"],
     "ans": "A", "marks": 1, "difficulty": "intermediate",
     "sol": "1÷3≈<strong>0.33</strong>. Answer: A",
     "hint": "<strong>Key idea:</strong> 1 ÷ 3 gives a recurring decimal 0.333… which rounds to 0.33 to 2 d.p."},
    {"q": "Increase 80 by 10% gives:",
     "opts": ["A  88", "B  90", "C  8", "D  108"],
     "ans": "A", "marks": 2, "difficulty": "intermediate",
     "sol": "10% of 80=8, 80+8=<strong>88</strong>. Answer: A",
     "hint": "<strong>Key idea:</strong> find 10% of 80 (= 8), then add to 80. Or multiply by 1.1."},
    {"q": "A price drops from £50 to £40. The percentage decrease is:",
     "opts": ["A  10%", "B  20%", "C  25%", "D  80%"],
     "ans": "B", "marks": 2, "difficulty": "difficult",
     "sol": "10/50=<strong>20%</strong>. Answer: B",
     "hint": "<strong>Key idea:</strong> change = 10, divide by the <em>original</em> £50: (10 ÷ 50) × 100 = 20%."},
    {"q": "0.2 recurring (0.2̄) as a fraction is:",
     ...
     "hint": (
         "<strong>Key idea:</strong> let x = 0.2̄, multiply by 10 → 10x = 2.2̄, subtract: 9x = 2, so x = 2/9."
     )},
    {"q": "3/8 as a decimal and percentage is:",
     ...
     "hint": "<strong>Key idea:</strong> 3 ÷ 8 = 0.375, then × 100 = 37.5%."},
    {"q": "Which equals 1/2?",
     "opts": ["A  0.2", "B  50%", "C  0.02", "D  5%"],
     "ans": "B", "marks": 1, "difficulty": "foundational",
     "sol": "1/2=<strong>50%</strong>. Answer: B",
     "hint": "<strong>Key idea:</strong> one half = 0.5 as a decimal = 50%."},
    {"q": "Find 3/8 of 240.",
     "opts": ["A  80", "B  90", "C  96", "D  72"],
     "ans": "B", "marks": 2, "difficulty": "intermediate",
     "sol": "240÷8=30, 30×3=<strong>90</strong>. Answer: B",
     "hint": "<strong>Key idea:</strong> find one eighth (240 ÷ 8 = 30), then multiply by 3 → 90."},
    {"q": "£150 is increased by 12%. What is the new amount?",
     ...
     "hint": "<strong>Key idea:</strong> 12% of £150 = £18, add to £150 → £168. Or £150 × 1.12."},
    {"q": "A £80 coat is reduced by 25% in a sale. What is the sale price?",
     ...
     "hint": "<strong>Key idea:</strong> discount = 25% of £80 = £20, subtract from £80 → £60."},
    {"q": "A value rises from 50 to 65. What is the percentage increase?",
     ...
     "hint": "<strong>Key idea:</strong> change = 15, divide by original 50: (15 ÷ 50) × 100 = 30%."},
    {"q": "After a 20% discount, the price is £56. What was the original price?",
     ...
     "hint": "<strong>Key idea:</strong> after 20% off, the price is 80% of original. Original = £56 ÷ 0.8 = £70."},
    {"q": "£200 is increased by 10% then decreased by 10%. The final amount is:",
     ...
     "hint": "<strong>Key idea:</strong> apply each change separately: ×1.1 then ×0.9. Do not add/subtract the percentages."},
    {"q": "Share £165 in the ratio 4:7. How much is the larger share?",
     ...
     "hint": "<strong>Key idea:</strong> 4 + 7 = 11 parts. One part = £165 ÷ 11 = £15. Larger share = 7 × £15 = £105."},
    {"q": "Bought for £40, sold for £52. The percentage profit is:",
     ...
     "hint": "<strong>Key idea:</strong> profit = £12. Percentage profit = (12 ÷ 40) × 100 = 30% (based on cost)."},
    {"q": "420 pupils: 5/12 walk to school. How many do not walk?",
     ...
     "hint": "<strong>Key idea:</strong> find 5/12 of 420 (= 175 who walk), then subtract: 420 − 175 = 245."},
    {"q": "After a 15% increase then a 10% decrease, the price is £103.50. The original price was:",
     ...
     "hint": "<strong>Key idea:</strong> combined multiplier = 1.15 × 0.9 = 1.035. Original = £103.50 ÷ 1.035 = £100."},
]
