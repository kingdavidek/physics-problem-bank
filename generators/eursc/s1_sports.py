...
_BR_POOLS = {
    "foundational": [
        ...
        _BR_MCQ("foundational", "heart", "The heart's job is to", _mcq_opts("digest food", "pump blood", "store oxygen as a metal", "measure distance"), "B", "The heart is a pump.", "This organ moves blood around the body. It is not a stomach, a metal store, or a tape measure."),
