...
_SS_POOLS = {
    "foundational": [
        ...
        _SS_MCQ("foundational", "planets_n", "How many planets are there in the Solar System?", _mcq_opts("two", "eight", "eighty", "one"), "B", "Eight planets orbit the Sun.", "Count the planets that orbit the Sun — not moons, not stars."),
    ...
    "difficult": [
        ...
        _SS_MCQ("difficult", "age", "The age of the universe is about", _mcq_opts("fourteen days", "fourteen billion years", "fourteen minutes", "eight planets"), "B", "About 14 billion years.", "The universe is billions of years old, not days or minutes."),
...
_LT_POOLS = {
    "foundational": [
        ...
        _LT_MCQ("foundational", "speed", "The speed of light is about", _mcq_opts("3 km/s", "300000 km/s", "8 m/s", "14 km/s"), "B", "About 300000 km/s.", "The speed of light is hundreds of thousands of kilometres each second, not a walking pace."),
...
_LF_POOLS = {
    "foundational": [
        ...
        _LF_MCQ("foundational", "water", "Liquid water matters because", _mcq_opts("it is a unit of time", "many Earth life processes happen in water", "it proves UFOs", "it is the same as a light-year"), "B", "Solvent / chemistry of life.", "Many Earth life processes happen in a liquid solvent. Which liquid is it?"),
        ...
        _LF_MCQ("foundational", "three", "How many items are in the simple needs list for life (energy, liquid water, chemicals)?", _mcq_opts("one", "three", "eight", "fourteen"), "B", "Three.", "Count the items named in the simple needs list: energy, liquid water, chemicals."),
    ...
    "difficult": [
        ...
        _LF_MCQ("difficult", "three_chem", "Energy, liquid water and chemicals are how many listed needs?", _mcq_opts("two", "three", "four", "zero"), "B", "Three.", "Count energy, liquid water and chemicals. That is how many needs there are."),
...
_AM_POOLS = {
    "foundational": [
        ...
        _AM_MCQ("foundational", "symbol", "The symbol O stands for", _mcq_opts("orbit", "oxygen", "a light-year", "a season"), "B", "Oxygen.", "The letter O is a chemical symbol for an element, not 'orbit' or a season."),
    ...
    "intermediate": [
        _AM_MCQ("intermediate", "h_symbol", "The symbol H stands for", _mcq_opts("helium", "hydrogen", "a habitat", "a light-year"), "B", "Hydrogen.", "The letter H is the symbol for one particular element — not helium, a habitat, or a distance unit."),
    ...
    "difficult": [
        ...
        _AM_MCQ("difficult", "fe", "The symbol Fe stands for", _mcq_opts("a season", "iron", "a filter", "a light-year"), "B", "Iron.", "The symbol Fe is a metal element, not a season or a light-year."),
