...
_PM_POOLS = {
    "foundational": [
        ...
        _PM_MCQ("foundational", "hormone", "Hormones are", _mcq_opts("rumours", "chemical messengers that help trigger puberty changes", "bones", "banned sports drinks only"), "B", "Hormones travel in the blood.", "They are chemicals that travel in the blood and carry messages that help trigger the changes of this stage."),
...
_RA_POOLS = {
    "foundational": [
        ...
        _RA_MCQ("foundational", "ovary", "An ovary's job is to", _mcq_opts("pump blood like the heart", "release eggs and make some hormones", "store urine only", "measure pulse"), "B", "Ovaries produce eggs.", "This organ releases eggs and also makes some chemical messengers. It is not the heart or the bladder."),
...
_PS_POOLS = {
    "foundational": [
        ...
        _PS_MCQ("foundational", "preg", "Pregnancy means", _mcq_opts("winning a match", "development after fertilisation, usually in the uterus", "a pulse of 80", "a friction force"), "B", "Development after fertilisation.", "After the sex cells join, development usually continues in the uterus."),
        ...
        _PS_MCQ("foundational", "orient", "Sexual orientation is the idea that", _mcq_opts("everyone must announce theirs in the quiz", "people can be attracted to different sexes; nobody is asked which applies to them", "orientation is a newton", "science forbids the topic"), "B", "Fact without disclosure.", "People can be attracted to different sexes. The lesson states that as a fact, without asking which applies to a pupil."),
