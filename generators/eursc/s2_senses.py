...
_VI_POOLS = {
    "foundational": [
        ...
        _VI_MCQ("foundational", "retina", "The retina", _mcq_opts("is a unit of time", "detects the image at the back of the eye", "is an advert", "must be photographed for the quiz"), "B", "Detector.", "Look for the detecting layer at the back of the eye, not a unit of time."),
        ...
        _VI_MCQ("foundational", "stereo", "Stereo depth uses", _mcq_opts("one identical view only, always", "two slightly different views from two eyes", "a rumour", "a private scoreboard"), "B", "Two views.", "Judging depth uses two slightly different views, not one identical photo."),
    ...
    "intermediate": [
        _VI_MCQ("intermediate", "near", "Near-sight means", _mcq_opts("near objects cannot be seen at all", "distant objects are not in focus", "the retina is a virus", "the quiz stores a prescription"), "B", "Far blur.", "Near-sight means far things are blurry, not that close things vanish."),
        _VI_MCQ("intermediate", "far", "Far-sight means", _mcq_opts("distant objects are the only possible image", "near objects are not in focus", "stereo is a food", "pupils must list glasses brands"), "B", "Near blur.", "Far-sight means close-up things are not sharp, not that only distant images exist."),
    ...
    "difficult": [
        ...
        _VI_MCQ("difficult", "both_err", "Near-sight and far-sight both", _mcq_opts("require a class league table", "are focusing errors, not a demand for private scores", "are smells", "are semicircular canals"), "B", "Focus errors.", "Both are focusing errors. They are not a demand for private scores."),
        ...
        _VI_MCQ("difficult", "accom2", "For a near object the lens", _mcq_opts("must be thrown away", "changes shape (accommodation)", "becomes a canal", "uploads a prescription"), "B", "Shape change.", "For something close, the focusing part changes shape rather than being thrown away."),
...
_HE_POOLS = {
    "foundational": [
        ...
        _HE_MCQ("foundational", "vib", "Sound is", _mcq_opts("a light-year of mass", "vibration that needs a medium", "a vaccine", "a private score"), "B", "Vibration in a medium.", "Sound is back-and-forth motion that needs something to travel through, not a vaccine."),
        ...
        _HE_MCQ("foundational", "aid", "A hearing aid is", _mcq_opts("a class league", "a tool that can help; the app does not store whose it is", "a bacterium", "a demand for a private test"), "B", "Tool, no file.", "An aid is a tool that can help. This app does not store whose it is."),
        _HE_MCQ("foundational", "medium", "Without a medium, sound", _mcq_opts("is louder", "does not travel as it does in air", "becomes a lens", "must be listed from home"), "B", "Needs a medium.", "If there is nothing to travel through, sound does not travel as it does in air."),
    ...
    "intermediate": [
        ...
        _HE_MCQ("intermediate", "loud", "Loudness is about", _mcq_opts("a food group", "how strong a sound is taken to be", "a retina", "publishing a test"), "B", "Strength.", "Loudness is about how strong a sound is taken to be, not a food group."),
...
_TO_POOLS = {
    "foundational": [
        _TO_MCQ("foundational", "pressure", "Pressure receptors detect", _mcq_opts("a light-year", "contact or pressure", "a vaccination file", "whose skin to rank"), "B", "Contact.", "These sensors pick up contact or pressure, not a light-year and not a ranking of skin."),
        _TO_MCQ("foundational", "temp", "Temperature receptors detect", _mcq_opts("a retina only", "hot or cold", "a glasses brand", "a class league"), "B", "Hot/cold.", "These sensors pick up hot or cold, not a glasses brand."),
    ...
    "intermediate": [
        ...
        _TO_MCQ("intermediate", "pain2", "Pain is", _mcq_opts("a popularity contest", "a warning sense, not a ranking of who is tougher", "a cochlea", "a stored diagnosis"), "B", "Warning.", "This warning sense is not a ranking of who is tougher."),
    ...
    "difficult": [
        ...
        _TO_MCQ("difficult", "three", "Pressure, temperature and pain are", _mcq_opts("one receptor only", "three kinds of receptor", "tastes", "prescriptions"), "B", "Three.", "Contact, hot-or-cold, and the warning sense are three kinds of receptor."),
...
_SM_POOLS = {
    "foundational": [
        ...
        _SM_MCQ("foundational", "range", "Receptor diversity means", _mcq_opts("one receptor for the whole species only", "many receptor types for different chemicals", "a class league", "a stored odour diary"), "B", "Many types.", "Diversity means many sensor types for different chemicals, not one sensor for the whole species."),
    ...
    "intermediate": [
        ...
        _SM_MCQ("intermediate", "many", "Many receptor types help because", _mcq_opts("there is only one chemical in air", "different chemicals can be distinguished", "noses must be ranked", "the app stores diaries"), "B", "Diversity.", "Many sensor types help because different chemicals can be distinguished."),
        ...
        _SM_MCQ("intermediate", "not_rank", "A better nose is", _mcq_opts("something to rank", "not a league table", "a prescription file", "a cochlea"), "B", "No league.", "A 'better nose' is not a league table."),
    ...
    "difficult": [
        ...
        _SM_MCQ("difficult", "not_one", "Saying there is only one smell receptor for the whole species", _mcq_opts("is correct", "does not match the many-receptor idea", "is a taste", "is a stored map"), "B", "Diversity.", "One sensor for the whole species does not match the many-receptor idea."),
        ...
        _SM_MCQ("difficult", "airborne", "Airborne chemicals are the stimulus for", _mcq_opts("stereo depth only", "smell", "a glasses file", "semicircular canals only"), "B", "Smell.", "Chemicals in the air are the stimulus for this airborne sense, not for stereo depth."),
...
_TA_POOLS = {
    "foundational": [
        _TA_MCQ("foundational", "five", "How many basic tastes are there?", _mcq_opts("one", "five", "eighty", "zero"), "B", "Five.", "The basic tastes are a small named list, not one and not eighty. Count the named set."),
        _TA_MCQ("foundational", "flavour", "Flavour", _mcq_opts("ignores smell", "uses taste and smell together", "is a glasses file", "ranks tongues"), "B", "Taste + smell.", "Flavour uses the tongue sense and the airborne sense together, not one of them alone."),
    ...
    "intermediate": [
        _TA_MCQ("intermediate", "umami", "Umami is", _mcq_opts("a hearing aid", "one of the five tastes", "a private menu", "a canal"), "B", "Fifth taste.", "The savoury fifth is one of the five, not a hearing aid."),
        ...
        _TA_MCQ("intermediate", "sour", "Sour is", _mcq_opts("not in the five", "one of the five tastes", "a retina", "a prescription"), "B", "In the five.", "Sour belongs in the five, not outside that set."),
        _TA_MCQ("intermediate", "bitter", "Bitter is", _mcq_opts("a glasses file", "one of the five tastes", "a class rank", "a vacuum"), "B", "In the five.", "Bitter also belongs in the five, not a glasses file."),
    ...
    "difficult": [
        ...
        _TA_MCQ("difficult", "not_five", "Ignoring smell when discussing flavour is", _mcq_opts("required", "an incomplete model", "a stored menu", "a hearing test"), "B", "Include smell.", "Ignoring the airborne sense when discussing flavour is an incomplete model."),
        ...
        _TA_MCQ("difficult", "five2", "Sweet, salt, sour, bitter and umami are", _mcq_opts("two tastes", "the five basic tastes", "ear regions", "prescriptions"), "B", "Five.", "Those five are the basic tastes, not two and not ear regions."),
...
_PR_POOLS = {
    "foundational": [
        ...
        _PR_MCQ("foundational", "canal", "Semicircular canals detect", _mcq_opts("only tastes", "rotation of the head", "a menu", "whose score to publish"), "B", "Rotation.", "The fluid-filled loops detect rotation of the head, not tastes."),
    ...
    "intermediate": [
        _PR_MCQ("intermediate", "together", "Canals, vision and proprioception", _mcq_opts("never interact", "work together", "must be ranked", "are stored as who felt dizzy"), "B", "Together.", "The loops, seeing, and position sense work together. They are not stored as who felt unwell."),
    ...
    "difficult": [
        _PR_MCQ("difficult", "mismatch", "If vision and canals disagree, a person may feel odd. That is", _mcq_opts("a reason to store who felt dizzy here", "a cue mismatch", "a menu", "forced spinning"), "B", "Mismatch.", "If seeing and the loops disagree, a person may feel odd. That is a cue mismatch."),
        _PR_MCQ("difficult", "not_rank", "Ranking who is least dizzy is", _mcq_opts("the aim of this quiz", "not allowed", "required SI", "a taste"), "B", "No ranking.", "Ranking who is least unwell is not allowed and is not the aim of this quiz."),
...
_IN_POOLS = {
    "foundational": [
        ...
        _IN_MCQ("foundational", "hunger", "Hunger is", _mcq_opts("a class confession", "an example of an internal signal, not a demand to log meals", "a canal rank", "a prescription file"), "B", "Example, no log.", "The need-for-food idea is an example of an internal signal, not a demand to log meals."),
        _IN_MCQ("foundational", "heart", "A heartbeat the person can notice is", _mcq_opts("a public league", "an internal signal, not a stored ECG", "a tongue rank", "a forced spin"), "B", "Signal, no ECG.", "A heartbeat a fictional person can notice is an internal signal, not a stored ECG."),
    ...
    "intermediate": [
        ...
        _IN_MCQ("intermediate", "well", "Wellbeing is", _mcq_opts("a mood ranking of the class", "an idea linked to how signals are interpreted, without a survey", "a stored diary", "a joke"), "B", "Idea, no survey.", "Wellbeing is an idea linked to how signals are interpreted, without a survey of the class."),
        _IN_MCQ("intermediate", "not_joke", "Treating internal signals as only a joke is", _mcq_opts("required", "not acceptable", "a canal fact", "an SI unit"), "B", "Not a joke.", "Treating internal signals as only a joke is not acceptable."),
    ...
    "difficult": [
        ...
        _IN_MCQ("difficult", "limit", "Which of these is true about this quiz?", _mcq_opts("that it diagnoses the class", "that it does not collect live feelings or replace a clinician", "that jokes replace support", "that moods must be compared"), "B", "No live feelings.", "This quiz does not collect live feelings or replace a clinician."),
...
_NH_POOLS = {
    "foundational": [
        ...
        _NH_MCQ("foundational", "ultra", "Ultrasound is", _mcq_opts("a food", "sound above the usual human hearing band", "a retina file", "a superpower rank"), "B", "Above human band.", "This is sound above the usual human hearing band, not a food."),
    ...
    "intermediate": [
        ...
        _NH_MCQ("intermediate", "em", "Electromagnetic sensing is", _mcq_opts("a spell", "a scientific model of detecting electric or magnetic cues", "a tongue rank", "forced spinning"), "B", "Model, not magic.", "Electromagnetic sensing is a scientific model of detecting electric or magnetic cues, not a spell."),
    ...
    "difficult": [
        ...
        _NH_MCQ("difficult", "both_sound", "Infrasound and ultrasound both", _mcq_opts("are tastes", "sit outside the usual human hearing band", "rank classmates", "are prescriptions"), "B", "Outside the band.", "Sound below the usual band and sound above it both sit outside the usual human hearing band."),
