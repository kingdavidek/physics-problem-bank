...
_FE_POOLS = {
    "foundational": [
        _FE_MCQ("foundational", "ghg", "Greenhouse gases are", _mcq_opts("a private confession", "a public atmosphere and climate idea", "a stored diet file", "a class rank"), "B", "Public climate idea.", "Look for gases in the air the class can discuss as a shared climate idea, not a private confession or a stored diet file."),
        ...
        _FE_MCQ("foundational", "waste_idea", "Food waste is", _mcq_opts("a demand to photograph plates", "a system leftover, not a private plate survey", "a magnet", "a shock survey"), "B", "System idea.", "Leftover food is a system idea for the class, not a demand to photograph anyone's plate."),
        ...
        _FE_MCQ("foundational", "land", "Land use in a food system can", _mcq_opts("never affect biodiversity", "affect habitats and biodiversity", "replace climate evidence", "rank classmates"), "B", "Land and biodiversity.", "Think how growing food can change habitats. That can affect variety of living things."),
    ...
    "intermediate": [
        _FE_MCQ("intermediate", "climate", "Climate change is linked to", _mcq_opts("a class popularity prize", "public evidence, not a household interrogation", "a joint map", "a vaccination"), "B", "Public evidence.", "Long-term weather-pattern change rests on public evidence, not a popularity prize or a household interrogation."),
        ...
        _FE_MCQ("intermediate", "foot", "A footprint idea is", _mcq_opts("a live family diary", "a public comparison, not a stored household file", "a lever", "a shock story"), "B", "Public comparison.", "A footprint figure is something the class can compare from public numbers, not a stored household file."),
        _FE_MCQ("intermediate", "sam", "Sam (fictional) wants a league of whose lunch is greener. The right response is", _mcq_opts("publish the league", "use public examples; do not rank plates here", "photograph the class", "skip waste"), "B", "No plate rank.", "Sam wants a lunch league. Science class can use public examples without ranking whose plate is greener."),
        _FE_MCQ("intermediate", "choice", "Sustainable choices are", _mcq_opts("a private confession", "public options the class can discuss", "a stored medical file", "a magnet pole"), "B", "Public options.", "Looking-after-the-planet options are things the class can discuss in the open, not a private confession or a medical file."),
        _FE_MCQ("intermediate", "life", "A food lifecycle", _mcq_opts("starts at waste only", "runs from produce through use to waste", "must be a home photo", "ranks families"), "B", "Produce to waste.", "Follow the food model from growing or making, through eating or using, to leftover material — not a home photo."),
    ...
    "difficult": [
        ...
        _FE_MCQ("difficult", "limit", "Which of these is true about this quiz?", _mcq_opts("that GHGs cannot be named", "that it does not collect private plates or family diaries", "that lifecycles are banned", "that climate is a vote"), "B", "No private harvest.", "Think what this quiz refuses to collect: private plates and family diaries. That is a limit, not a ban on naming gases."),
...
_ECY_POOLS = {
    "foundational": [
        _EC_MCQ("foundational", "eco", "An ecosystem is", _mcq_opts("a class vote", "living things and their surroundings", "a stored diet", "a household rank"), "B", "Living things plus surroundings.", "Think of living things together with the place around them, not a class vote or a stored diet."),
        ...
        _EC_MCQ("foundational", "water", "The water cycle is", _mcq_opts("a private diary", "public stages water can move through", "a magnet league", "a shock survey"), "B", "Public stages.", "Water moving through named public stages is the cycle idea here, not a private diary or a magnet league."),
        _EC_MCQ("foundational", "alex_ec", "Alex (fictional) names a plant as a producer. That fits", _mcq_opts("a pupil ranking", "the producer role", "a stored file", "a plate survey"), "B", "Producer.", "Alex names a plant that makes food. That matches the first trophic role, not a pupil ranking."),
    ...
    "intermediate": [
        ...
        _EC_MCQ("intermediate", "carbon", "The carbon cycle is", _mcq_opts("a class league", "public stages carbon can move through", "a joint map", "a fridge photo"), "B", "Public stages.", "This cycle moves an element through public stages the class can name, not a league or a fridge photo."),
        _EC_MCQ("intermediate", "photo", "Photosynthesis is", _mcq_opts("a demand to log meals", "a word-equation idea linking light, carbon dioxide and a food store", "a stored clinical file", "a robot league"), "B", "Word-equation idea.", "Photosynthesis is a word equation linking light, a gas in air, and a food store — not a meal log."),
        _EC_MCQ("intermediate", "sam_ec", "Sam (fictional) says a decomposer is optional in every web. A science reply is", _mcq_opts("agree always", "decomposers return matter", "rank Sam", "skip water"), "B", "Return matter.", "Sam thinks the breakdown role is optional. That role returns matter. Do not rank Sam."),
        _EC_MCQ("intermediate", "resp", "Respiration is", _mcq_opts("a private confession", "a word-equation idea that can release energy from a food store", "a household rank", "a key couplet"), "B", "Word-equation idea.", "This word-equation idea can release energy from a food store. It is not a private confession or a household rank."),
    ...
    "difficult": [
        ...
        _EC_MCQ("difficult", "jordan_ec", "Jordan (fictional) wants a league of who is most like a wolf. The right response is", _mcq_opts("publish the league", "study trophic roles; do not rank pupils as animals", "store files", "skip cycles"), "B", "No ranking.", "Jordan wants a wolf-likeness league. Study trophic roles; do not rank pupils as animals."),
        _EC_MCQ("difficult", "both_ec", "Photosynthesis and respiration both", _mcq_opts("require a plate photo", "are word-equation ideas", "rank classmates", "inspect homes"), "B", "Word equations.", "Making a food store with light and releasing energy from a food store are both word-equation ideas here."),
        ...
        _EC_MCQ("difficult", "limit_ec", "Which of these is true about this quiz?", _mcq_opts("that producers cannot be named", "that it does not replace a field visit or rank pupils as animals", "that cycles are banned", "that webs are illegal"), "B", "Support only.", "This quiz supports ideas in class. It does not replace a field visit or rank pupils as animals."),
...
_CH_POOLS = {
    "foundational": [
        _CH_MCQ("foundational", "abiotic", "Abiotic factors are", _mcq_opts("always classmates", "non-living conditions such as light or temperature", "a stored diet", "a shock survey"), "B", "Non-living conditions.", "These factors are non-living conditions such as light or temperature, not classmates or a stored diet."),
        ...
        _CH_MCQ("foundational", "biotic", "Biotic factors are", _mcq_opts("only rocks", "living influences such as feeding or competition", "a household rank", "a magnet"), "B", "Living influences.", "These factors are living influences such as feeding or competition, not rocks or a magnet."),
    ...
    "intermediate": [
        ...
        _CH_MCQ("intermediate", "thermo", "Thermoregulation is", _mcq_opts("a pupil ranking", "a public animal example, not a classmate league", "a stored clinical file", "a carbon diary"), "B", "Public example.", "Keeping a steady body temperature is a public animal example, not a classmate league."),
        ...
        _CH_MCQ("intermediate", "activity", "Activity of an animal is", _mcq_opts("a demand to track classmates", "a public example linked to conditions, not a pupil tracker", "a diet file", "a V = IR claim"), "B", "Public example.", "Animal activity is a public example linked to conditions, not a demand to track classmates."),
    ...
    "difficult": [
        ...
        _CH_MCQ("difficult", "jordan_ch", "Jordan (fictional) wants a league of whose garden is wildest. The right response is", _mcq_opts("publish the league", "use a class survey; do not rank backyards here", "upload photos to the app", "skip abiotic factors"), "B", "No backyard rank.", "Jordan wants a wildest-garden league. Use a class survey; do not rank backyards in this app."),
        _CH_MCQ("difficult", "both_ch", "Abiotic and biotic factors both", _mcq_opts("must be a home confession", "help describe an ecosystem", "rank classmates", "replace the teacher"), "B", "Describe the system.", "Non-living conditions and living influences both help describe an ecosystem here. Neither is a home confession."),
...
_CL_POOLS = {
    "foundational": [
        _CL_MCQ("foundational", "species", "A species is", _mcq_opts("a class popularity prize", "a grouping idea", "a stored diet", "a shock survey"), "B", "Grouping idea.", "This grouping idea organises living things. It is not a popularity prize."),
        ...
        _CL_MCQ("foundational", "groups", "Broad groups are", _mcq_opts("a diet file", "named sets used to organise living things", "a shock story", "a V = IR claim"), "B", "Named sets.", "Broad named sets organise living things. They are not a diet file or a shock story."),
    ...
    "intermediate": [
        ...
        _CL_MCQ("intermediate", "taxonomy", "Taxonomy is", _mcq_opts("a class league", "a historical grouping system, including Linnaeus", "a stored clinical file", "a carbon diary"), "B", "Grouping system.", "This historical grouping system includes Linnaeus. It is not a class league."),
        _CL_MCQ("intermediate", "descent", "Common descent is", _mcq_opts("a pupil ranking", "a scientific model, not a class ranking", "a fridge photo", "a shock survey"), "B", "Scientific model.", "Shared ancestry is a scientific model, not a ranking of classmates."),
        _CL_MCQ("intermediate", "sam_cl", "Sam (fictional) wants to upload a home insect box. The right response is", _mcq_opts("upload it here", "use public examples; do not harvest a private collection", "rank Sam", "skip keys"), "B", "Public examples.", "Sam wants to upload a home insect box. Use public examples; do not harvest a private collection here."),
        ...
        _CL_MCQ("intermediate", "key", "A dichotomous key", _mcq_opts("asks many features at once always", "asks one checkable feature at a time", "must be a home secret", "ranks classmates"), "B", "One feature at a time.", "A dichotomous key asks one checkable feature at a time, not many at once."),
    ...
    "difficult": [
        ...
        _CL_MCQ("difficult", "jordan_cl", "Jordan (fictional) wants a league of who is most related to an ape. The right response is", _mcq_opts("publish the league", "teach common descent as a model; do not rank pupils", "store files", "skip keys"), "B", "No ranking.", "Jordan wants an ape-relatedness league. Teach shared ancestry as a model; do not rank pupils."),
        _CL_MCQ("difficult", "sustain", "Sustainability is", _mcq_opts("a private confession", "a public idea linked to biodiversity, not a household interrogation", "a stored diet", "a magnet"), "B", "Public idea.", "Looking after living things is a public idea linked to variety of life, not a household interrogation."),
