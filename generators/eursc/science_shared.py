...
SYLLABUS_MODULES = {
    ...
    "1.2.7": {
        ...
        "objectives": (
            ...
            "Convert between kilojoules and kilocalories",
    ...
    "1.3.3": {
        ...
        "objectives": (
            ...
            "Describe pressure and buoyancy in water sport",
        ),
    },
    "1.3.4": {
        "slug": "sport_health",
    ...
    "1.4.3": {
        ...
        "objectives": (
            ...
            "Outline fetal development and birth",
    ...
    "2.3.1": {
        ...
        "objectives": (
            ...
            "Distinguish near-sight and far-sight as focusing errors",
    ...
    "2.3.3": {
        ...
        "checkpoints": 4,
        "objectives": (
            "Name touch receptor types (pressure, pain, temperature)",
    ...
    "2.3.8": {
        ...
        "objectives": (
            ...
            "Distinguish infrasound and ultrasound from the human hearing band",
    ...
    "3.1.1": {
        ...
        "objectives": (
            ...
            "Name simple machine types (lever, pulley, ramp)",
    ...
    "3.1.3": {
        ...
        "checkpoints": 6,
        "objectives": (
            "Describe charging by friction or contact",
    ...
    "3.1.4": {
        ...
        "objectives": (
            ...
            "Read meters to compare and describe, without V = IR calculations",
    ...
    "3.1.5": {
        ...
        "objectives": (
            ...
            "Classify materials as magnetic or not",
    ...
    "3.2.2": {
        ...
        "checkpoints": 8,
        "objectives": (
            "Describe an ecosystem as living things and their surroundings",
    ...
    "3.2.4": {
        ...
        "checkpoints": 8,
        "objectives": (
            "Describe a species as a grouping idea",
            ...
            "Name broad groups of living things",
...
def outbreak_bars(*, title=None, max_width=360):
    ...
    return svg(
        ...
        desc="A is 2 cases, B is 4 cases, and C is 8 cases. Axes are day and cases. A made-up example, not a real outbreak.",
        body=body,
        max_width=max_width,
        variant="wide",
    )
