...
| **Phase U (UI redesign)** | **U0–U8 + polish shipped** (U6 no inline `style=`; U7.9 sound toggle default off; U1.6–U1.9 pill/list-row/avatar polish). CSS ~202KB uncompressed (210KB budget cap). Cache: `pb-v60`. Spec: `docs/UI_REDESIGN.md`. |
