...
| **Phase U (UI redesign)** | **U0–U5 shipped.** U7.1–U7.8 shipped. **U6.1–U6.6 shipped** (lesson vocabulary, migrator, applied templates, attribute-selector compensation removed, radioactivity folded onto base/tokens). Next: **U6.7** delete unrouted stubs, then U6.8 stray `.py`, then U8. Spec: `docs/UI_REDESIGN.md` §9. Cache: `pb-v57`. |
