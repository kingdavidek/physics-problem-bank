...
| **Mascot motion + onboarding (E7)** | **Planned, decisions frozen (2026-09-20)** — CSS budget raised 226→240KB total / 199→210KB core; no third-party animation library (Lottie/GSAP/Rive stay banned); cosmetics layer on the same rig instead of a second character, automatic/content-facing first. **Phases 1 through 2 built and pushed (2026-09-22 through 2026-09-24); Phase 3 (mobile welcome flow, `/welcome`) built and reviewed 2026-09-26, post-review fixes applied, awaiting David's sign-off before committing.** Spec: `docs/MASCOT_MOTION_AND_ONBOARDING.md`. |
