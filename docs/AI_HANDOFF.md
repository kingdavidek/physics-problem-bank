...
| *European School Practice generator* | `docs/EURSC_GENERATOR_HANDOFF.md`, canvas `eursc-generator-question-plan.canvas.tsx` | **Next** — Phase 0 on cue |
