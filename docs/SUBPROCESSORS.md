...
| jsDelivr | MathJax and Pyodide static assets | Visitor IP, user agent | Global CDN | None | Accepted until S2.2 (self-host) |
...
**Removed in S0.11:** Google Fonts. Work Sans and Source Serif 4 are served from `/static/fonts/`.
