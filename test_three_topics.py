...
with open("/home/ubuntu/gcse_three_topics_generator_additions.py", "r", encoding="utf-8") as f:
    code = f.read()
exec(compile(code, "/home/ubuntu/gcse_three_topics_generator_additions.py", "exec"), namespace)

topics = [
    ("ratio_proportion", "gcse_ratio_proportion", "gcse_ratio_proportion_variants"),
...
print("All three GCSE Maths topic generators passed runtime checks.")
